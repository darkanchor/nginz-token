...
Read `CLAUDE.md` for the project's architecture, binding conventions, and build and test commands. Its rules also apply here: do not commit or push unless explicitly asked, and treat `submodules/` as read-only.
